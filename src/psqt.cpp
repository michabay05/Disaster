...
// [Phase][Colorless (int)Piece][Square]
//const int positionalScores[2][6][64] =
const std::array<std::array<std::array<int, 64>, 6>, 2> positionalScore =
{{
...
int PSQTEval(const Phase phase, const PieceTypes piece, const int sq) {
    return positionalScore[(int)phase][(int)piece][sq];
}
